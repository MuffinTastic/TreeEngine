...
bool Tree::ManagedHostSystem::LoadNETCore()
{
	...
	int rc = m_initRuntimeFn( configPath.c_str(), nullptr, &context );
	...
	m_setRuntimePropertyFn( context, SAP_STR("APP_CONTEXT_BASE_DIRECTORY"), enginePath.c_str() );
	m_setRuntimePropertyFn( context, SAP_STR("APP_PATHS"), enginePath.c_str() );
	m_setRuntimePropertyFn( context, SAP_STR("APP_NI_PATHS"), enginePath.c_str() );
	m_setRuntimePropertyFn( context, SAP_STR("NATIVE_DLL_SEARCH_DIRECTORIES"), enginePath.c_str() );
	m_setRuntimePropertyFn( context, SAP_STR("PLATFORM_RESOURCE_ROOTS"), enginePath.c_str() );
